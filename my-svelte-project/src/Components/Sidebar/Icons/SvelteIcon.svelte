<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 139 139" class="svelte-c8tyih"
  ><path
    class="fill-current text-white group-hover:text-prime"
  ...
  />
  <path
    class="fill-current text-prime group-hover:text-white"
